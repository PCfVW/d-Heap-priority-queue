...
Beyond the textbook `small.json`, six benchmark graphs are reproducibly generated by [`benchmarks/scripts/graphgen/`](../../benchmarks/scripts/graphgen/) and conform to [`graphs/GRAMMAR.md`](graphs/GRAMMAR.md):
