...
In-progress v2.6.0 work — *Instrumentation & Benchmarks*. Phase 1 (test graph corpus + tooling + GRAMMAR spec) complete; Phase 2 (cross-language comparison-count instrumentation) complete for **all five** languages (C++, Go, Rust, TypeScript, Zig); Phase 3 (benchmark runners + results) not started.
