# Condition 2: Doc-Guided Prompt (Documentation Assistance)

## Purpose

This prompt provides the core requirements plus detailed API documentation describing the expected behavior of each operation, edge cases, and semantic details.
...
- This prompt adds:
  - Explanation of identity vs priority semantics
  - Parent/child index formulas for d-ary heap
  - Position map concept and purpose
  - Detailed pre/postconditions for each operation
  - Algorithm hints (sift up/down)
  - Time complexity expectations
  - Edge case specifications

- This tests whether documentation alone (Level 2: pattern-matchable templates) helps the model produce correct code.
