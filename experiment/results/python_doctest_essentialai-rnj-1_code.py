...
class DHeap:
    ...
    def insert(self, item: Item) -> None:
        ...
        self.position_map[item.number] = index
    ...
    def increase_priority(self, item: Item) -> None:
        ...
        self.heap[index] = Item(item.number, item.cost)
        self._bubble_up(index)
    ...
    def _bubble_up(self, index: int):
        ...
        while index > 0 and self.heap[index].cost < self.heap[parent_index].cost:
    ...
    def _bubble_down(self, index: int):
        ...
        for i in range(1, self.d + 1):
            ...
            if child_index < len(self.heap) and \
                    self.heap[child_index].cost < self.heap[smallest].cost:
    ...
    def _swap(self, i: int, j: int):
        ...
        self.position_map[item_i.number] = j
        self.position_map[item_j.number] = i
